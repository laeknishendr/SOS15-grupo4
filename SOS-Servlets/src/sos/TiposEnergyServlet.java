...
public class TiposEnergyServlet extends HttpServlet {
	...
	public void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		/*
		 * Este método, que utilizaremos como método por defecto para todos los
		 * comandos, tendremos que pillar el contenido de la URL, el método por
		 * el que se ha accedido y generar una respuesta.
		 */
	...
	private void processResourceList(String method, HttpServletRequest req, HttpServletResponse resp) throws IOException {

		switch (method) {

		case "POST":
			postEnergies(req, resp);
			break;

		case "GET":
			getEnergies(req, resp);
			break;
	...
	private void getEnergies(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		while (it.hasNext()) {
			...
			Energy en = new Energy((String) aux1.getProperty("name"), (Double) aux1.getProperty("no_fossil"), (Double) aux1.getProperty("fossil"), (Double) aux1.getProperty("temperature"));
	...
	@SuppressWarnings("static-access")
	private void processResource(String method, String resource, HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		case "GET":
			getEnergy(req, resp, e);
			break;

		case "PUT":
			updateEnergy(req, resp, resource);
			break;
	...
	@SuppressWarnings("static-access")
	private void getEnergy(HttpServletRequest req, HttpServletResponse resp, Entity e) throws IOException {
		...
		if (e == null) {
			...
			Energy en = new Energy((String) e.getProperty("name"), (double) e.getProperty("no_fossil"), (double) e.getProperty("fossil"), (double) e.getProperty("temperature"));
	...
	@SuppressWarnings("static-access")
	private void updateEnergy(HttpServletRequest req, HttpServletResponse resp, String resource) throws IOException {
